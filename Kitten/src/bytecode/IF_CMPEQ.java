...
public class IF_CMPEQ extends BranchingComparisonBytecode {
	 ...
	 *
	 * @return an {@code if_cmpne} bytecode of the same type as this
	 */
	...
	/**
	 * Auxiliary method which adds to the given list of instructions the code that
	 * goes to {@code yes} if the outcome of the test expressed by this branching bytecode is true.
	 * Namely, it generates the Java bytecode<br>
	 * <br>
	 * {@¢ode if_icmpeq yes}<br>
	 * <br>
	 * for {@code int} and Boolean values (Booleans are represented as integers in
	 * Java bytecode, with the assumption that 0 = <i>false</i> and 1 = <i>true</i>),<br>
	 * <br>
	 ...
	 * {@code ifeq yes}<br>
	 * <br>
	 * for {@code float} values. The {@code fcmpl} Java bytecode operates over
