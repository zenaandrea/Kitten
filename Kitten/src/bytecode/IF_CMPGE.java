...
public class IF_CMPGE extends BranchingNumericalComparisonBytecode {
	...
	/**
	 * Constructs a bytecode that compares the top two elements of the stack to check if
	 * the one but last is greater than or equal to the top one.
	 *
	 ...
	 * {@code ifge yes}<br>
	 * <br>
	 * for {@code float}. The {@code fcmpl} Java bytecode operates over
