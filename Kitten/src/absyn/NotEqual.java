...
/**
 * A node of abstract syntax representing an non-equality test between two expressions.
 *
 * @author <A HREF="mailto:fausto.spoto@univr.it">Fausto Spoto</A>
 */

public class NotEqual extends ComparisonBinOp {

	/**
	 * Constructs the abstract syntax of a non-equality test between two expressions.
	 *
	...
	public NotEqual(int pos, Expression left, Expression right) {
		super(pos, left, right);
	}

	/**
	 * Performs the type-checking of a non-equality test between two expressions.
	 ...
	 * the same value, and this test is hence useless and considered as type incorrect.
	 *
